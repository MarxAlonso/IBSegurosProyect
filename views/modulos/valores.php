...
<div class="row">
        <div class="col-md-4">
<h1 class="mt-4 b" style="text-align: justify; font-family: sans-serif; 
font-size: 19px;  padding: 18px 97px;color:#00000094 ;margin-bottom: 50px;padding-top:25px">
  <li>Confianza</li>
    <li>Compromiso</li>
    <li>Innovación</li>
    <li>Excelencia</li>
...
font-size: 19px;  padding: 6px 7px;color:#00000094 ;margin-bottom: 50px;padding-top:0px">Seleccionamos estos valores corporativos para IBSEGUROS porque representan los principios 
fundamentales que guían nuestra empresa en el sector del seguro. La confianza es esencial para construir relaciones sólidas con nuestros clientes, el compromiso muestra nuestra dedicación
hacia ellos, la innovación nos permite adaptarnos y mejorar constantemente, y la excelencia es el estándar que perseguimos en todos nuestros servicios y operaciones. Estos valores nos permiten 
brindar un servicio excepcional, mantenernos ala vanguardia en un mercado competitivo y garantizar la protección y tranquilidad de nuestros clientes en todo momento.</h1>
</div>
</div>
</div>
</div>
            ...
            <div class="row">
                <div class="col-md-5 order-md-1 d-flex align-items-center justify-content-center">
                    <div class="text-center" style="width:100%">
                        <img src="views/images/job.png" alt="Descripción de la imagen" class="img-fluid" style="margin-left:47%;  max-width: 80%; margin-top:-65px">
                    </div>
                </div>
