                        ...
                        <P>¡En IBSEGUROS, nos enorgullece ser una fuente confiable de seguridad y tranquilidad </br>
                            para nuestros clientes!</P>
                                 <div class="contenedor">
                                        <a class="enlace2 mision" href="" style="margin-left:93%">
...
font-size: 57px;  padding: 18px;color:black ;margin-bottom: 50px; margin-bottom:15px">MISIÓN</h2>



<h1 class="mt-4 a" style="text-align: justify; font-family: sans-serif; 
font-size: 19px;  padding: 18px 97px;color:#00000094 ;margin-bottom: 50px;">Ser la fuente de seguridad y tranquilidad líder en el mercado, ofreciendo soluciones de seguros confiables
y servicios financieros de calidad que protegen lo que más valoran nuestros clientes, acompañándolos en cada etapa de su vida.</h1>
...
<section class="contact_section layout_padding-bottom mt-5">
            ...
            <div class="row">
                <div class="col-md-5 order-md-1 d-flex align-items-center justify-content-center">
                    <div class="text-center" style="width:100%">
                        <img src="views/images/labour-day.png" alt="Descripción de la imagen" class="img-fluid" style="margin-left:33%;  max-width: 117%">
                    </div>
                </div>
    ...
    <h1 style="font-size: 18px; color: white; padding: 5px; font-weight:100">En <strong style="font-weight: bold;">IBSEGUROS</strong>, contamos con un equipo de expertos en seguros dedicados a brindarte un asesoramiento personalizado
     y soluciones adaptadas a tus necesidades. <strong style="font-weight: bold;">Nuestra amplia gama de seguros incluye coberturas para vida, salud, vehículo, hogar, responsabilidad civil</strong>, y
     mucho más.</h1>
</div>
