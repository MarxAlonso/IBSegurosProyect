...
<body>
  ...
  <div class="banner">
    <img src="views/images/gears-banner.jpg" alt="Imagen de ejemplo">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro TREC, conocido "Todo Riesgo Equipo de Contratista", es una 
póliza diseñada para <strong>proteger equipos de construcción y maquinaria utilizados en proyectos de obrea civil.</strong> Esta cobertura
asegura contra una variedad de riesgos, incluyendo vuelcos, hundimientos, incendios, vandalismo, y daños durante el transporte.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrece protección integral para equipos de construcción contra una amplia gama de riesgos</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Garantiza la continuidad de los proyectos al proporcionar una rápida compensación por daños materiales</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Mitiga los riesgos financieros al cubrir los costos de reparación o reemplazo de equipos dañados</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro TREC</h1>
                            ...
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <img src="views/images/shaking-hands2.jpg" style="height: 299px;width: 100%;" />
                                        <div class="mensaje_hover">
                                            <p> <strong>• Cubre </strong> los <strong>costos legales asociados</strong>
                                                con la defensa del asegurado en caso <strong> de demandas</strong></p>

                                            <p><strong>• Proporciona compensación financiera </strong>en caso el asegurado sea 
                                                culpable</p>
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                            ...
                                            Seguro de Responsabilidad Civil </p>
                                        </div>
                    ...
                    <div class="carousel__elemento">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        <img src="views/images/factory.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                     
                                            <p><strong>• Protección </strong>durante un viaje o una <strong>situación 
                                                de riesgo temporal.
                                            </strong></p>
                                            <p><strong>Ver más...</strong></p>
