...
<body>
  ...
  <div class="banner">
    <img src="views/images/office-banner.jpg" alt="Imagen de ejemplo">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguro de Lucro Cesante</h1>
    </div>
  </div>
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de lucro cesante es una póliza diseñada <strong>para proteger 
a las empresas contra la pérdida de ingresos que resulta de la interrupción de sus operaciones debido a un evento cubierto,</strong> como un incendio,
 una inundación u otros desastres. Este tipo de seguro cubre los gastos fijos y proporciona una compensación por la pérdida de ingresos durante el
período en que la empresa no puede operar normalmente.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Proporcionamos una compensación financiera para cubrir los ingresos perdidos durante el período en que la emrpesa esta inactiva</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubrimos los gastos fijos de la empresa, como alquiler, salarios y facturas de servicios públicos</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ayudamos a garantizar la continuidad de negocio al proporcionar una fuente de ingresos para cubrir los costos operativos </h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro Lucro-Cesante</h1>
                            ...
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <p><strong>• Cubre los gastos de reparación  o reemplazo de la embarcación</strong></p>

                                            <p><strong>• Ofrece cobertura</strong> para reclamaciones de <strong> responsabilidad civil</strong></p>
                    ...
                    <div class="carousel__elemento">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px;height:371px">
                                        <img src="views/images/gears.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                        <p><strong>• Ofrece protección integral para equipos de construcción contra una amplia gama de riesgos</strong></p>

                                                 <p><strong>• Garantiza la continuidad de los proyectos</strong> al proporcionar una rápida compensacíón </p>
                                ...
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        ...
                                        <div class="mensaje_hover">
                                            ...
                                            <p><strong>• Ofrece protección contra múltiples riesgos, </strong> como incendios, robos, daños por agua, 
                                                        responsabilidad civil</strong></p>
                                            
                                            <p><strong> • Reduce la complejidad</strong> al combinar múltiples coberturas</p>
                                            <p><strong>Ver más...</strong></p>
