...
<body>
  ...
  <div class="banner">
    <img src="views/images/caucion-credito.jpg" alt="caucion-credito">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguro de Caución/ <br>Crédito</h1>
    </div>
  </div>
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de caución o de crédito es una póliza que <b>ofrece garantías financieras a las partes involucradas en una transacción,</b> como un contrato o un préstamo. Este tipo de seguro <b>actúa como una garantía de cumplimiento de obligaciones financieras,</b> protegiendo a los beneficiarios en caso de incuplimiento por parte del asegurado.</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/currency.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 27%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Te protege financieramente ante los daños causados por incendios</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; ">Cubre los costos de reparación o reposición de los bienes</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto; margin-bottom: 40px;">
                    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de Caución / Crédito</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Caución / Crédito" selected>Caución / Crédito</option>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                                <li>Ofrece una <b>cobertura</b> completa <b>para proteger los equipos y maquinarias</b></li>
                                                <li><b>Ayuda a mitigar los riesgos financieros asociados con daños o pérdidas de equipos</b> </li>
                                        </ul>
                                    </div>
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                            ...
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:700;font-size:15px">
                                            Seguro EAR </p>
                                        </div>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1">
                                    <ul>
                                                <li><b>Cubre</b> los <b>costos legales asociados</b> con la defensa del asegurado en caso <b>de demandas</b></li>
                                                <li><b>Proporciona compensación financiera en caso asegurado sea culpable</b></li>
                                        </ul>
                                    </div>
                                        <img src="views/images/fondo-sctr.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                       
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:650;font-size:15px">
