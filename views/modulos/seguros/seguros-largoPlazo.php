...
<body>
  ...
  <div class="banner"style="height:450px">
    <img src="views/images/banner-financial_accident.jpg" alt="Imagen de ejemplo">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguros de Vida a Largo Plazo</h1>
    </div>
  </div>
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de vida a largo plazo es una póliza que ofrece
<strong> protección financiera a los beneficiarios del asegurado durante un periodo prolongado </strong>de tiempo, generalmente
décadas.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Brinda seguridad financiera a los beneficiarios del asegurado</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Facilita la planificación patrimonial</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Permite acumular un valor en efectivo con el tiempo</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro Vida Largo Plazo</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro Vida Largo Plazo" selected>Seguro Vida Largo Plazo</option>
                                ...
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <div class="mensaje_hover">
                                            <p> <strong>• Ofrecemos</strong>
                                               cobertura para <strong>reparar</strong> o
                                            <strong>reconstruir la vivienda</strong></p>

                                            <p><strong>• Protegemos los bienes personales</strong> dentro
                                                del hogar</p>
