...
<body>
  ...
  <div class="banner">
    <img src="views/images/earimg.jpg" alt="Imagen de ejemplo">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro EAR, abreviatura de "Equipo de Aseguramiento de Riesgos", es una <b>póliza diseñada para proteger equipos y maquinaria utilizados en proyectos de construcción, ingeniería y otros sectores industriales.</b> Esta cobertura asegura contra una amplia gama de riesgos, incluyendo daños accidentales, robo, vandalismo y daños durante el transporte.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrece una cobertura amplia para proteger los equipos contra pérdidas o daños durante el desarrollo de proyectos industriales</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Migra los riesgos financieros de reparación o reemplazo de equipos dañados</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 25%;display: block;margin: 0 auto;">
                    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de EAR</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="EAR" selected>EAR</option>
                            ...
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        ...
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                            <p> • <b>Ofrece protección contra</b> una variedad de <b>riesgos que pueden surgir</b> durante el desarrollo de <b>proyectos de construcción</b></p>
                                            <p><strong>• Garantiza la continuidad de los proyectos al proporcionar una compensación por daños materiales</strong></p>
