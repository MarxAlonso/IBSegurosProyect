...
<body>
  ...
  <div class="banner">
    <img src="views/images/fondo-sctr.jpg" alt="SCTR">
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro Complementario de Trabajo de Riesgo (STCR) es un seguro obligatorio en el Perú que <b>brinda cobertura de salud y protección económica a los trabajadores</b> en caso de <b>accidentes laborales o enfermedades ocupacionales.</b></h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/teamwork.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 65%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Proporcionamos atención médica para lesiones o enfermedades relacionadas con el trabajo.</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrecemos compensación económica en caso de incapacidad temporal o permanente</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Brindamos beneficios a los dependientes del trabajador en caso de fallecimiento</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de SCTR</h1>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1" style="top:45%">
                                    <ul>
                                        ...
                                        <img src="views/images/incendios2.jpg" style="height: 299px;width: 100%;" />
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1"style="top:45%">
                                    <ul>
                                                <li><b>Compensación financiera</b> en casos de que los <b>bienes asegurados sean robados</b></li>
                                                <li>Pólizas pueden incluir <b>servicios de asistencia</b></li>
                                        </ul>
                                        Ver más...
                                    </div>
                                        <img src="views/images/robos-asaltos2.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
