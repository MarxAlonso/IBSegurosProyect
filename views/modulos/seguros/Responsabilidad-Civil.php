...
<head>
  ...
  <style>
    .banner {
      position: relative;
      text-align: center;
      height: 388px; /* Altura fija del banner */
...
<body>
  ...
  <div class="banner">
    <img src="views/images/shaking-banner.jpg" alt="caucion-credito">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguro de<br>Responsabilidad Civil</h1>
    </div>
  </div>
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de responsabilidad civil es una póliza <b>diseñada para proteger a los asegurados contra reclamaciones de responsabilidad civil</b> que pueden surgir como resultado de lesiones personales o daños a la propiedad de terceros durante el curso de sus actividades comerciales o personales. <b>Esta cobertura puede ser vital para proteger los activos y la reputación de un individuo o negocio en caso de demandas legales.</b></h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/finance.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto; margin-bottom: 20px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubre los costos legales asociados con la defensa del asegurado en caso de demandas por lesiones personales o daños</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/currency.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 23%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Proporciona compensación financiera en caso de que el asegurado sea considerado responsable de causar lesiones personales</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 26%;display: block;margin: 0 auto; margin-bottom: 40px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Banda tranquilidad al asegurado al saber que está protegido contra las consecuencias financieras</h1>
                </div>
            </div>
        </div>
    </div>
...
<section id="Responsabilidad-Civil">
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de Responsabilidad Civil</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Responsabilidad Civil" selected>Responsabilidad Civil</option>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                                <li><b>Cubre los gastos de reparación  o reemplazo de la embarcación</b></li>
                                                <li><b>Ofrece cobertura</b> para reclamaciones de <b> responsabilidad civil</b></li>
                                        </ul>
                                    </div>
                                        <img src="views/images/digital-art2.png" style="height: 299px;width: 100%;" />
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog card1"style="border-radius:   50px;height:371px">
                                    <div class="overlay-seguros"></div>
                                    <div class="overlay-text1" style="left:51% ;width:85%">
                                    <ul>
                                    <li><b>Proporciona una compensación financiera</b> para <b>cubrir los ingresos perdidos</b>
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                            ...
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:650;">
                                             Seguro TREC
                                            </p>
                                        </div>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1" style="left:51% ;width:85%">
                                        <ul>
                                                <li><b>Ofrece protección contra múltiples riesgos,</b> como incendios, robos, daños por agua, 
                                                        responsabilidad civil</li>
                                                <li><b>Reduce la complejidad</b> al combinar múltiples coberturas</li>
                                        </ul>
