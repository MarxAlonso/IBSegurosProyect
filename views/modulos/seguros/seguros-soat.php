...
<body>
  ...
  <div class="banner">
    <img src="views/images/cars-4814015_1280.jpg" alt="Imagen de ejemplo">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro Obligatorio de Accidentes de Tránsito (SOAT) es un seguro
obligatorio en muchos países que brinda <strong> cobertura médica y económica a las víctimas de accidentes de tráfico,</strong> sin importar 
quién sea responsable del accidente.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubrimos los gastos de atención médica de víctimas</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">El SOAT ofrece indemnizaciones a sus familiares o a los propios afectados </h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/Hospital.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 23%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Te protegemos de los altos costos de la atención médica</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro SOAT</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro SOAT" selected>Seguro SOAT</option>
