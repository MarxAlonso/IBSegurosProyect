...
<head>
  ...
  <style>
    ...
    h1 {
      font-size: 100px; /* Reduzco el tamaño del texto para mejor visualización */
...
<body>
  ...
  <div class="banner">
    <img src="views/images/factory.jpg" alt="Imagen de ejemplo">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguro de Rotura de Maquinaria</h1>
    </div>
  </div>
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de rotura de maquinaria es una póliza <strong> diseñada
para proteger a los propietarios de maquinaria industrial y equipos de contra los costos asociados con la reparación o reemplazo de maquinaria
</strong> que sufre daños mecánicos o eléctricos inesperados. Esta cobertura puede ser crucial para empresas de maquinaria especializada para su
operación, ya que ayuda a mitigar los riesgos financieros asociados con averías inesperadas.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubre los costos de reparación o reemplazo de maquinaria dañada devido a roturas mecánicas o eléctricas inesperadas</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ayuda a minimizar las interrupciones en la producción al proporcionar una rápida compensación de maquinaria</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Brinda tranquilidad al propietario de la empresa al saber que está protegido contra los costos imprevistos asociados con las averías de las maquinaria</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro Rotura-Maquinaria</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro de Ahorro" selected>Seguro de Ahorro</option>
                            ...
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <p><strong>• Ofrece protección contra </strong> una variedad de 
                                            <strong> riesgos que pueden surgir</strong> durante el desarrollo de 
                                            <strong> proyectos de construcción</strong></p>

                                            <p><strong>• Garantiza la continuidad de los proyectos </strong>al proporcionar una compesación por 
                                                daños materiales
                                          </p>
                            ...
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px;height:371px">
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                        <p><strong>• Ofrece protección contra multiples riesgos </strong> u como incendio, robos, daños por agua,
                                                 responsabilidad civil</p>

                                                 <p><strong>• Reduce la complejidad</strong> combinar múltiples coberturas</p>
                    ...
                    <div class="carousel__elemento">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        <img src="views/images/caucion-credito.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                     
                                            <p><strong>• Proporciona una garantia </strong>de <strong>que </strong> el asegurado
                                            <strong> cumplira con sus obligaciones financieras</strong></p>
                                            
                                            <p>• Ayuda a <strong> mitigar el riesgo de perdidas financieras </strong></p>
                                            <p><strong>Ver más...</strong></p>
                                                                    
                                         </div>
                                          
                                            <p class="p-0 m-0 text-center" style="color:#606060;font-weight:700">
                                              Seguro Caución/Crédito  </p>
                                        </div>
