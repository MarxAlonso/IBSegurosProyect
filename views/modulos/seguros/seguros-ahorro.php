...
<body>
  ...
  <div class="banner">
    <img src="views/images/salud2.jpg" alt="Imagen de ejemplo">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguros de Ahorro</h1>
    </div>
  </div>
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">Los seguros de ahorro son productos financieros que ofrecen una conbinacion de proteccion y ahorro.
Funcionan de dos maneras: primero,<strong> te brindan proteccion en caso de eventos abversos </strong>coomo enfermedades graves, accidentes o fallecimiento, proporcionando una 
suma asegurada a tus beneficios en caso de que ocurra alguno de estos eventos. Segundo, <strong>te permiten ahorrar dinero a corto plazo</strong> 
ya que parte de tus pagos de primas se invierten en instrumentos financieros con el objetivo de generar rendimientos y acumular un capital.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Proteccion financiera en caso de eventos imprevistos</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/wallet.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Te permitimos acumular un capital a lo largo del tiempo</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/checklist.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 15%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Un plan financiero a largo plazo que pueda ayudar a alcanzar metas</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro de Ahorro</h1>
