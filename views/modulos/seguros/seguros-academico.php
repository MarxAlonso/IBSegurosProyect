...
<body>
  ...
  <div class="banner" style="height:410px">
    <img src="views/images/students.jpg" alt="Imagen de ejemplo" Style="height:123%">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguros Académico</h1>
    </div>
  </div>
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro academico es una poliza diseñada para 
<strong> proteger la inversion en la educación de un estudiante, </strong> brindando cobertura financiera en caso de
eventos adversos que puedan afectar su capacidad para continuar con sus estudios.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ayudamos a cubrir los gastos de matricula y colegiatura</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Permite al estudiante continuar con sus estudios sin interrupciones financieras</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Aseguramos la educación del menor</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro Académico</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro Académico" selected>Seguro Académico</option>
