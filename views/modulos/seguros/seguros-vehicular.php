...
<head>
  ...
  <style>
    .banner {
      position: relative;
      text-align: center;
      height: 418px; /* Ajusté la altura del banner para que coincida con el estilo inline */
      overflow: hidden; /* Oculta cualquier contenido que sobresalga del contenedor */
    }
    .banner img {
      width: 100%;
      height: 100%; /* Cambié la altura a 100% */
...
<body>
  ...
  <div class="banner">
    <img src="views/images/watch-916395_1280.jpg" alt="Imagen de ejemplo">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro vehicular es una póliza que brinda
<strong> protección financiera a los propietarios de vehículos en caso de accidentes </strong>o daños a su automóvil,
<strong> asi como a terceros afectados</strong> por el accidente.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrece indemnización para reparar el vehículo</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/bike.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 38%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Servicios de asistencia en carretera, como remolque, cambio de neumáticos,etc</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/car-insurance.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 41%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubre los gastos legales y la compensación para terceros en caso de lesiones</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro Vehicular</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro Vehicular" selected>Seguro Vehicular</option>
                            ...
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <img src="views/images/cars.jpg" style="height: 299px;width: 100%;" />
                                        <div class="mensaje_hover">
                                            <p> • Garantizamos la <strong>estabilidad financiera</strong> durante 
                                                un periodo especifico</p>
                            ...
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px;height:371px">
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                            <p>• Garantizamos la <strong> estabilidad  financiera</strong>durante un período específico</p>
                                            <p><strong>• Protección</strong> durante un viaje o una 
                                                <strong>situación de risego temporal.</strong></p>
                    ...
                    <div class="carousel__elemento">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        <img src="views/images/houses.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                        <div class="mensaje_hover">
                                            <p><strong> • Ofrecemos </strong> cobertura para 
                                            <strong>reparar </strong> o <strong> reconstruir la vivienda</strong> </p>
                                            <p><strong>• Protegemos los vienes personales del hogar </strong></p>
                                            <p><strong>Ver más...</strong></p>
