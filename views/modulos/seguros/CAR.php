...
<head>
  ...
  <style>
    .banner {
      position: relative;
      text-align: center;
      height: 420px; /* Altura fija del banner */
    ...
    .overlay {
      ...
      width: 100%;
      height: 100%;
      background-color:rgba(22, 61, 116, 0.4); /* Utiliza rgba() para especificar la opacidad */
      display: flex;
...
<body>
  ...
  <div class="banner">
    <img src="views/images/architect-banner.jpg" alt="Imagen de ejemplo">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro CAR, o "Contratistas de Todo Riesgo", es un póliza diseñada para <b>brindar protección integral a los contratistas y propietarios de proyectos de construcción.</b> Esta cobertura asegura contra una amplia gama de riesgos, <b>incluyendo daños accidentales, robos, vandalismo, incendios y responsabilidad civil.</b></h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 35%;display: block;margin: 0 auto; margin-bottom: -30px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrece protección contra una variedad de riesgos que pueden surgir durante el desarrollo de proyectos de construcción</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/industrial-insurance.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 26%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Garantiza la continuidad de los proyectos al proporcionar una compensación por daños materiales</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/currency.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 20%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ayuda a mitigar los riesgos financieros al cubrir los costos de reparación o reemplazo de la propiedad dañada</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros CAR</h1>
                                ...
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <div class="mensaje_hover">
                                            <p> <strong>• Ofrece protección contra multiples riesgos,</strong> como incendios, robos, daños por agua, responsabilidad civil</p>

                                            <p>• <b>Reduce la complejidad</b> al combinar múltiples coberturas</p>
                                ...
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                            ...
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:700">
                                            Seguro de Rotura de Maquinaria </p>
                                        </div>
