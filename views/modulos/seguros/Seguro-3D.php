...
<body>
  ...
  <div class="banner">
    <img src="views/images/Car-3d.jpg" alt="caucion-credito">
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro 3D, también conocido como Daños, Defensa y Daños a Terceros, es un tipo de póliza de <b>seguro de automóvil</b> que <b>brinda cobertura amplia para proteger al asegurado en caso de accidentes de tráfico.</b> Esta cobertura generalmente incluye tres componentes principales:</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/car-insurance.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 35%;display: block;margin: 0 auto; margin-bottom: 40px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;"><b>Daños Propios:</b> Cubre los daños materiales sufridos por el vehículo del asegurado, ya sea por colisiones, vuelcos u otros tipos de accidentes</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; "><b>Defensa Legal:</b> Proporciona asistencia legal y cubre los gastos legales asociados con la defensa del asegurado</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;"><b>Daños a Terceros:</b> Cubre los daños materiales y personales causados a terceros</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro 3D</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro 3D" selected>Seguro 3D</option>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1"style="top:45%;width:74%">
                                        <ul>
                                ...
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1"style="top:45%;width:74%">
                                        <ul>
                                                ...
                                                <li><b>Protección</b> durante un viaje o una <b>situación de riesgo temporal.</b></li>
                                        </ul>
                                        Ver más...
                                    </div>
