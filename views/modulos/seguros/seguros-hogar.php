...
<body>
  ...
  <div class="banner" style="height:480px">
    <img src="views/images/houses-6504533_1280.jpg" alt="Imagen de ejemplo" Style="height:auto;width:100%;margin-top: -32%;">
...
font-size: 16px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro de hogar es una póliza diseñada para  
<strong> proteger la vivienda y los bienes personales </strong> contra diversos riesgos,<strong> como incendios,
        robos, daños por agua y resposabilidad civil.</strong>.</h1>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro de Hogar</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro de Hogar" selected>Seguro de Hogar</option>
                                ...
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <div class="mensaje_hover">
                                            <p> <strong>• Ofrecemos renumeraciones</strong>
                                                mensuales asegurables.</p>

                                            <p><strong>• Protegemos contra la invalidez Total</strong>
                                                 y Permanente por Accidente.</p>
