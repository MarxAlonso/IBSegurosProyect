...
<body>
  ...
  <div class="banner">
    <img src="views/images/vida-ley.jpg" alt="Imagen de ejemplo">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguros Ley de Vida</h1>
    </div>
  </div>
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El Seguro de Vida Ley es un seguro obligatorio en Perú que brinda <b>protección financiera a los trabajadores</b> y sus beneficiarios en caso de fallecimiento o invalide< total y permanent <b>debido a un accidente laboral o una enfermedad ocupacional.</b></h1>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de Vida Ley</h1>
                            ...
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                        ...
                                        <img src="views/images/EPS2.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
