...
<head>
  ...
  <style>
    .banner {
      position: relative;
      text-align: center;
      height: 360px; /* Altura fija del banner */
...
<body>
  ...
  <div class="banner">
    <img src="views/images/EPS.jpg" alt="Imagen de ejemplo">
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">La Entidades Prestadoras de Salud (EPS) son empresas especializadas en <b>brindar servicios de atención médica privada a los trabajadores</b> que están afiliados a ellas. Estas entidades funcionan como complemento a la cobertura de EsSalud, ofreciendo a los colaboradores la posibilidad de acceder a un plan de salud privado que les proporciona una atención médica más personalizada y ágil. <b>Las EPS suelen contar con una amplia red de hospitales, clínicas y profesionales de la salud</b>, lo que garantiza a los trabajadores una atención de calidad y una cobertura integral para sus necesidades de salud.</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/curita.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto; margin-bottom: 45px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cobertura ilimitada, copagos fijos sin deducibles</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto; margin-bottom: 38px;">
                    </div>
                ...
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/medico.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cobertura oncológica al 100%, Medicina Interna, Pediatría, Obstetrícia y más </h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de EPS</h1>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                                <li><b>Cobertura integral para salud</b> y seguridad en el trabajo</li>
                                                <li><b>Pólizas flexibles</b> adaptadas a las características de tu empresa y <b>necesidades específicas.</b></li>
                                        </ul>
                                    </div>
                                        <img src="views/images/sctrimagen.jpg" style="height: 299px;width: 100%;" />
                            ...
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                        ...
                                        <img src="views/images/vida-ley.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1">
                                    <ul>
                                                <li>Garantizamos la <b>estabilidad financiera</b> durante un periodo específico</li>
                                                <li><b>Protección</b> durante un viaje o uuna <b>situación de riesgo temporal.</b></li>
                                        </ul>
                                        Ver más...
                                    </div>
                                        <img src="views/images/image_fx_a_thief_in_the_mall.jpg" style="height: 299px;width: 100%;" />
                                        <div class="p-4 " style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                           
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:700">
                                            Seguro Contra Robos y Asaltos </p>
                                        </div>
