...
<body>
  ...
  <div class="banner"style="height:398px">
    <img src="views/images/family-960449_1280.jpg" alt="Imagen de ejemplo">
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El "seguro de selud" es un tipo de póliza de seguro que <strong>proporciona 
cobertura fnanciera para gastos medicos y de salud.</strong> Esta cobertura puede incluir consultas médicas, hospitalizacion, medicamentos 
recetados, cirugias y otros serviciosrealcionados con la salud.<strong>El objetivo principal del seguro de salud es ayudar a los asegurados 
a cubrir los costos asociados con la atencion médica</strong>,brindándoles acceso a servicios médicos sinincurrir en gastos significativos de su bolsillo.</h1>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/img-salud2.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Atención ambulancia y hospitalaria.</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/img-salud.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Te protegemos si eres trabajador independiente</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                        <img src="views/images/img-salud3.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 30%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Programas preventivos gratuitos para diversas etapas de tu vida.</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguro de Salud</h1>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-natural">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Seguro de Salud" selected>Seguro de Salud</option>
                                                        ...
                                                        <div
                                                                ...
                                                                <div class="col-lg-5 campos-persona-empresa">
                                                                        ...
                                                                        <select required class="form-control"
                                                                                ...
                                                                                <option value="Aviación" selected>Seguro de Salud</option>
                            ...
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog" style="border-radius:50px; height:371px">
                                        ...
                                        <img src="views/images/emergency-room - 2.jpg" style="height: 299px;width: 100%;" />
                                        <div class="mensaje_hover">
                                            <p> <strong>• Beneficios por fallecimiento Accidental</strong></p>
                                            <p><strong>•Asistencia medica</strong> en caso de accidentes,
                                                muerte accidental e incapacidad temporal
                                                <strong>a partir de un accidente</strong>.</p>
                                            <p><strong>Ver más...</strong></p>
                                                                    
                                         </div>
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgba(182, 217, 255, 0.5));transition: background 0.3s ease;">
                                           
                                            <p class="p-0 m-0 text-center" style="color:#606060; font-weight:700">
                                            Seguro contra Accidentes </p>
                                        </div>
                    ...
                    <a href="seguros-ahorro" class="enlace_personalizado">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px;height:371px">
                                        <img src="views/images/salud2 - 2.jpg" style="height: 299px;width: 100%;" />

                                        <div class="mensaje_hover">
                                            <p> <strong> •Proporcionamos </strong>beneficios en caso de
                                            <strong>fallecimiento del titular</strong> del seguro durante el plazo
                                                del contrato</p>
                                            <p><strong>•Tu familia estará protegida desde el primer dia</strong>.</p>
                                            <p><strong>Ver más...</strong></p>
                    ...
                    <a href="seguros-cortoPlazo" class="enlace_personalizado">
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    <div class="card__blog"style="border-radius:   50px; height:371px">
                                        <img src="views/images/salud - 2.jpg" style="height: 299px;width: 100%;" />
                                        <div class="mensaje_hover">
                                            <p>•Garantizamos<strong> la estabilidad financiera </strong>durante el periodo especifico</p>
                                            <p><strong>•Protección</strong>durante un viaje o una 
                                            <strong>situación de riesgo temporal. </strong></p>
                                            <p><strong>Ver más...</strong></p>
                                        ...
                                        <div class="p-4" style="background: linear-gradient(122deg, #439ddf, rgb(182, 217, 255, 0.5));">
                                            ...
                                            <p class="p-0 m-0 text-center" style="color:#606060;font-weight:700">
                                              Seguro de vida a Corto Plazo  </p>
                                        </div>
