...
<body>
  ...
  <div class="banner">
    <img src="views/images/incendios.jpg" alt="SCTR">
    <div class="overlay"></div>
    <div class="banner-text">
      <h1>Seguro Contra Incendios</h1>
    </div>
  </div>
...
font-size: 17px;  padding: 18px;color:#00000094 ;margin-bottom: 50px;">El seguro contra incendios es una póliza diseñada para <b>proteger a los propietarios</b> de viviendas, negocios u otras propiedades <b>contra los daños causados por incendios.</b> Este tipo de seguro cubre los costos de reparacion o reconstrucción de la propiedad en caso de que sufra daños debido a un incendio. Además de la cobertura básica para daños por fuego, algunas pólizas también pueden incluir cobertura adicional para otros tipos de daños relacionados con incendios, como daños por humo, agua o extinción de incendios.</h1>
        ...
        <div class="layout_padding-top layout_padding2-bottom">
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img src="views/images/currency.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 25%;display: block;margin: 0 auto;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Te protege financieramente ante los daños</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    ...
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Cubre los costos de reparación o reposición de los bienes</h1>
                </div>
                <div class="col-md-4">
                    <div style="text-align: center;">
                    <img src="views/images/add-tasks.png" alt="Descripción de la imagen" class="img-fluid" style="max-width: 25%;display: block;margin: 0 auto; margin-bottom: 53px;">
                    </div>
                    <h1 class="mt-4" style="text-align: center; font-family: sans-serif; font-size: 17px; padding: 18px; color: #00000094; margin-bottom: 50px;">Ofrece asistencia en caso de incendio</h1>
                </div>
            </div>
        </div>
    </div>
                                                ...
                                                <div class="row pt-5 justify-content-center row_contacto_principal">
                                                        <div class="col-lg-12 texto_contenedor_contacto_ibcostructor">
                                                                <h1 class="mt-4 mb-4 contact_title text-center"
                                                                        style="color:white">Seguros de Incendio</h1>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos_blog container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <div class="overlay-text1" style="width:58%">
                                    <ul>
                                                <li><b>Compensación financiera</b> para reparar o reemplazar los bienes <b>dañados</b></li>
                                                <li>Ayuda a <b>proteger el patrimonio</b> del asegurado al cubrir los costos de construcción</li>
                                        </ul>
                                        Ver más...
                                    </div>
                        ...
                        <div class="container-fluid cards-inicio">
                            <div class="lista_elementos container homeport1">
                                <div class="card_elemento">
                                    ...
                                    <ul>
                                                <li>Proporcionamos atención médica</li>
